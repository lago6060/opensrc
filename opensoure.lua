...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		...
		if func then
			func("https://discord.gg/avs9fP8BsU")
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.gg/avs9fP8BsU)"
	end)
	dragGUI(main)
	main.Parent = PARENT
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	...
	if toClipboard then
		...
		notify('Discord Invite', 'Copied to clipboard!\nhttps://discord.gg/avs9fP8BsU')
	else
		notify('Discord Invite', 'https://discord.gg/avs9fP8BsU')
	end
